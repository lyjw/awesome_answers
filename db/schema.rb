...
ActiveRecord::Schema.define(version: 20160524211230) do
  ...
  add_index "insights", ["question_id"], name: "index_insights_on_question_id", using: :btree
  ...
  add_foreign_key "insights", "questions"
